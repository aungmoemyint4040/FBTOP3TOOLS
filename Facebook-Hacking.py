...
def cover():
    print """
     ...
     """
    run(GG+"          Welcome To Myanmar")
    run(CC+" https://github.com/aungmoemyint404.com")
    run(GG+"           FACEBOOK HACKING")
    time.sleep(1)
    print (RR+"")
    print (" █▀▀▀ █▀▀█ █▀▀█ █▀▀▀ █▀▀█ █▀▀▀█ █▀▀▀█ █░▄▀   ")
    print (" █▀▀▀ █▄▄█ █░░░ █▀▀▀ █▀▀▄ █░░▒█ █░░▒█ █▀▄░   ")
...
passwordlist = str(raw_input(RR+"ENDER File Password.txt\033[33;1m: "))
